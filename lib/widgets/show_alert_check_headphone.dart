        ...
        child: AlertDialog(
          ...
          content: Container(
            ...
            child: Column(
              ...
              children: [
                const Expanded(flex:3,child: Text('Kindly check whether the Headphones are plugged in.',style: TextStyle(fontFamily: 'Blinker',color: Colors.white,fontSize:20,fontWeight: FontWeight.bold),)),
               // const Spacer(flex: 1,),
